...
<div class="calrow"><div class="calf"><label>Tank Height (cm)</label><input type="number" id="cTH" step="0.1"><div class="calh">Sensor to tank bottom</div></div>
<div class="calf"><label>Low Threshold (%)</label><input type="number" id="cLo" step="1"><div class="calh">Pump ON below this</div></div></div>
<div class="calf"><label>High Threshold (%)</label><input type="number" id="cHi" step="1"><div class="calh">Pump OFF above this</div></div></div>
...
var loadCal=function(){
  fetch('/calibrate').then(function(r){return r.json()}).then(function(d){
    ...
    document.getElementById('cTH').value=d.tankH.toFixed(1);
...
var saveCal=function(){
  var q='?ph7v='+document.getElementById('cP7').value+'&ph4v='+document.getElementById('cP4').value
    ...
    +'&tankH='+document.getElementById('cTH').value+'&lowTh='+document.getElementById('cLo').value
...
var resetCal=function(){
  ...
  document.getElementById('cTH').value='30.0';document.getElementById('cLo').value='20';
